...
import static com.github.t9t.jooq.generated.Tables.JOOQ_JSON_TEST;
...
public class JsonbStringBindingIT {
    ...
    public void selectJson() {
        Record1<String> r = dsl.select(JOOQ_JSON_TEST.DATA)
                .from(JOOQ_JSON_TEST)
                .where(JOOQ_JSON_TEST.NAME.eq("both"))
                .fetchOne();
    ...
    public void selectJsonEmpty() {
        Record1<String> r = dsl.select(JOOQ_JSON_TEST.DATA)
                .from(JOOQ_JSON_TEST)
                .where(JOOQ_JSON_TEST.NAME.eq("empty"))
                .fetchOne();
    ...
    public void selectJsonNull() {
        Record1<String> r = dsl.select(JOOQ_JSON_TEST.DATA)
                .from(JOOQ_JSON_TEST)
                .where(JOOQ_JSON_TEST.NAME.eq("null"))
                .fetchOne();
    ...
    public void selectJsonb() {
        Record1<String> r = dsl.select(JOOQ_JSON_TEST.DATAB)
                .from(JOOQ_JSON_TEST)
                .where(JOOQ_JSON_TEST.NAME.eq("both"))
                .fetchOne();
